function [comPrecoder, priPrecoder, wsr] = slrs_solver(weight, bcChannel, snr, comEqualizer, priEqualizer, comWeight, priWeight)
% Function:
%   - solve the optimum common and private precoders for single-layer rate-splitting multiple access
%
% InputArg(s):
